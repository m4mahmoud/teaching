...
window.playCourseVideo = (videoId) => {
	...
	containerEl.innerHTML = `
        <button onclick="location.reload()" style="background: none; border: none; color: #B4863A; cursor: pointer; font-weight: bold; font-size: 0.9rem; margin-bottom: 10px; display: block;">
            🔙 العودة لقائمة الحصص
        </button>
